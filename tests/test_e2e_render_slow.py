...
def test_assemble_and_render_e2e(tmp_path):
    ...
    parts_script = repo_root / 'blend' / 'create_parts_template.py'
    parts_out = repo_root / 'blend' / 'cybercam_parts.blend'
    ...
    master_path = repo_root / 'blend' / 'cybercam_master.blend'
...
""")
    ...
    assemble_script = repo_root / 'scripts' / 'build' / 'assemble_cam.py'
