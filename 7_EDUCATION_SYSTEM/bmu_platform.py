...
# Base de datos de certificaciones del Arquitecto
CERTIFICATIONS = {
    "ia_neuronal": {
...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-label">Costo con Beca (3+)</div>
                <div class="stat-value" style="font-size: 2rem;">GRATIS</div>
            </div>
        </div>

        <!-- Rutas de Carrera -->
        <h2 class="section-title">🚀 Rutas de Carrera Multidisciplinaria</h2>
            ...
            <div class="path-info">
                <div class="path-detail">
                    ...
                    <ul style="color: #888; padding-left: 1.5rem; margin-top: 0.5rem;">
                        ...
                        <li>{{ certifications[area].nombre }}</li>
                        {% endfor %}
                    </ul>
                </div>
                <div class="path-detail">
                ...
                <div class="path-detail">
                    <strong>Costo sin Beca:</strong>
                    <span style="color: #ff4444; text-decoration: line-through;">{{ path.costo_sin_beca }}</span>
                </div>
                <div class="path-detail">
                    <strong>Con Beca de Audacia:</strong>
        ...
        <h2 class="section-title">📚 Catálogo Completo de Certificaciones</h2>
        <div class="categories-grid">
            {% for cat_id, category in certifications.items() %}
        ...
        <div class="cta-section">
            <h2 class="cta-title">¿Listo para la Audacia?</h2>
            <p class="cta-text">
                Elige 3 o más áreas y accede al programa completo sin costo.<br>
    ...
    <script>
        ...
        console.log('Total Certificaciones:', {{ total_certs }});
        console.log('Filosofía: Paga por una si quieres lujo; estudia tres y el Rey te las paga todas');
    </script>
</body>
</html>
"""
...
def index():
    ...
    total_certs = sum(len(cat['cursos']) for cat in CERTIFICATIONS.values())
    total_areas = len(CERTIFICATIONS)
    total_hours = sum(
...
def get_catalog():
    ...
    return jsonify({
        "certifications": CERTIFICATIONS,
        "career_paths": CAREER_PATHS,
        "philosophy": "Paga por una si quieres lujo; estudia tres y el Rey te las paga todas",
...
def get_career_path(path_id):
    ...
    detailed_areas = [CERTIFICATIONS[area] for area in path['areas']]
